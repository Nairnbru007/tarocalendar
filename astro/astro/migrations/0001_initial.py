    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alarm', models.BooleanField(default=False, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Users',
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(0, 'Зарегистрированный'), (1, 'Начальный'), (2, 'Продвинутый'), (3, 'Полный')], default=0, null=True, verbose_name='Роль')),
